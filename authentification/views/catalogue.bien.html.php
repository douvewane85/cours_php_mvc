      ...
      <?php  foreach ($biens['data'] as $key => $bien):?>
            <div class="col-sm-4 mb-4">
                <div class="card" style="width: 22rem">
                    <img
                    class="card-img-top"
                    src="<?=!empty($bien['photo'])? ROOT."public".DIRECTORY_SEPARATOR."images".DIRECTORY_SEPARATOR."uploads".DIRECTORY_SEPARATOR.$bien['photo']:'https://source.unsplash.com/1080x720/?product'?>"
                    alt="Annonce 1"
                    />
                    <div class="card-body">
                    <h5 class="card-title"> 
                    ...
                    <a href="<?=!is_connect()?"index.php?controler=security&page=login&action=reservation.visiteur&bien_id=".$bien['id']:"index.php?controler=reservation&page=reservation.visiteur&action=reservation.visiteur&bien_id=".$bien['id'] ?>" class="btn btn-sm btn-outline-warning "
                        >Reserver</a
                    >
