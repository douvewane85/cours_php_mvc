<?php
    ob_start() ;
       if((!isset($_GET['bien_id']) || !is_numeric($_GET['bien_id'])))  redirect_url("reservation","show.reservation"); 
       if(isset($_GET['bien_id'])){
          $reservations=get_reservation_bien($_GET['bien_id']);
          $title="Reservation du Bien client  ".$_GET['bien_id'];
       }
