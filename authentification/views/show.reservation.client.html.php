<?php
     ob_start();
      ...
      if(isset($_GET['client_id'])){
            if( !is_numeric($_GET['client_id']))  redirect_url("reservation","show.reservation");
            $reservations=get_reservation_client((int)$_GET['client_id']);
       }else{
          $reservations=get_reservation_client($_SESSION['user_connect']['id']);
       }
