...
<div class="container mb-5">
        ...
        <form action="<?=WEBROOT.'index.php'?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-2 offset-sm-10 float-right ">
                   <button type="submit" class="btn btn-primary " name="btn_submit" value="btn_add_bien">Enregistrer</button>
                </div>
        </form>
</div>
