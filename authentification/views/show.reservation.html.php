 ...
 <div class="container mt-3 ">
         ...
         <table class="table table-bordered   w-100">
             <thead class="thead-inverse">
                 ...
                 <?php foreach( $reservations['data'] as $bien): ?>
                     <tr>
                         <td class="w-15"><a href="index.php?controler=reservation&page=show.reservation.client&client_id=<?=$bien['client_id']?>" class="nav-link text-dark text-capitalize font-weight-bold"><?=$bien['nom_complet']?></a></td>
                         <td class="w-25"><a href="index.php?controler=reservation&page=show.reservation.bien&bien_id=<?=$bien['bien_id']?>" class="nav-link text-dark text-capitalize font-weight-bold"><?=sprintf("%s %s ",$bien['ref'],$bien['type'])?></a></td>
                         ...
                         <td>
                             <a  href="index.php?controler=reservation&page=edit.reservation&id=<?=$bien['reservation_id']?>" class="btn btn-success  mr-2" ><i class="fa fa-list">  </i></a>
