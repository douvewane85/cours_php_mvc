<?php
      if(!isset($_GET['id']) || !is_numeric($_GET['id']))  redirect_url("reservation","show.reservation");
       ob_start() ;
         $bien =get_reservation_id((int)$_GET['id'])['data'];
        ...
        <div class="col-sm-8 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="#" class="btn btn-sm btn-success float-right">Valider</a
              >
            </div>
          </div>
        </div>
